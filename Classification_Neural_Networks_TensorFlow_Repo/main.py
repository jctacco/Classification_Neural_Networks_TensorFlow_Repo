...
if __name__ == "__main__":
    ...
    base_path = "Classification_Neural_Networks_TensorFlow_Repo/models"
    visual_base_path = "Classification_Neural_Networks_TensorFlow_Repo/reports/figures"
    # Load the dataset
    data_path = "Classification_Neural_Networks_TensorFlow_Repo/data/raw/employee_attrition.csv"
